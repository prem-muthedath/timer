...
public class TextReport extends Report {
	...
	public TextReport(Order order) {
		super(order);
	}	

	protected TestGroup methodGroup(int size, String method, double timing) {
		addHeader(size(size));
	...
	protected TestGroup sizeGroup(int size, String method, double timing) {
	...
	protected void printHeader() {
		...
		System.out.println(margin+header);
	}	
}