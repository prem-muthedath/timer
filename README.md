...
These concerns led me to a different design with a new set of small objects, each doing just 1 thing.  After much struggle, I found the object names from Beck's description of his timer framework!
